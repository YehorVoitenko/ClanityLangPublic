...
CORRECT_WORD_PHRASES = [
    "<b>🌟 Чудово! Твоє слово написане бездоганно.</b>",
    "<b>💡 Супер! Це правильна відповідь.</b>",
    "<b>🎯 Влучно! Точно так і треба.</b>",
    "<b>🔥 Блискуче! Абсолютно правильно.</b>",
    "<b>🏆 Молодець! Слово написано правильно.</b>",
    "<b>✨ Відмінно! Усе на 100% вірно.</b>",
    "<b>👏 Браво! Правильна відповідь.</b>",
    "<b>🚀 Суперрезультат! Ти справився з цим словом.</b>",
    "<b>📚 Ідеально! Так і має бути.</b>",
    "<b>💪 Клас! Це правильне написання.</b>",
]
...
class InteractivePhrases(Enum):
    ...
    CORRECT_USER_WORD = "Наступне слово 👉 <b>{next_original_word}</b>"
    INCORRECT_USER_WORD = "Правильна відповідь: <b>{correct_answer}</b>\n\nПереклади 👉 <b>{next_word}</b>"
    ...
    INSTRUCTION = (
        ...
        "<i> - будь-де</i>\n"
        "<i> - будь-коли</i>\n\n"
        "ти можеш використовувати різні типу ігор ❤️‍🔥"
    )
